...
decks = [
    {
        ...
        "slides": [
            {"bg": IMG/"techniques/double-cleansing-2.webp", "kicker": "Erreur française", "title": "Le savon de Marseille est trop haut pour ton visage.", "body": "Ta peau vit autour de pH 4,5 à 5,5. Le savon classique peut monter vers 9 ou 10.", "cta": "Sauvegarde avant de laver ton visage au savon."},
    ...
    },
    {
        ...
        "slides": [
            ...
            {"bg": IMG/"techniques/double-cleansing-2.webp", "kicker": "Erreur", "title": "Le citron, le savon, l'eau chaude : trio faux ami.", "body": "Naturel ne veut pas dire compatible avec ton manteau acide.", "cta": "Simple ne veut pas dire brutal."},
    ...
    },
    {
        ...
        "slides": [
            ...
            {"bg": IMG/"techniques/skin-flooding-body-1.webp", "kicker": "Attente", "title": "On vise moins visible, pas invisible.", "body": "Le but réaliste: surface plus régulière, brillance mieux tenue, taches qui s'installent moins.", "cta": "Pas de filtre, juste une meilleure logique."},
    ...
    },
    {
        ...
        "slides": [
            ...
            {"bg": IMG/"techniques/double-cleansing-2.webp", "kicker": "SPF", "title": "Sans SPF, la marque s'accroche.", "body": "Le matin, la réparation post-bouton finit toujours par protection solaire.", "cta": "La lumière décide souvent de la tache."},
    ...
    },
    {
        ...
        "slides": [
            ...
            {"bg": IMG/"basics/la-barriere-cutanee-body-1.webp", "kicker": "À éviter", "title": "Pas sur inflammation active.", "body": "Boutons douloureux, folliculite, zone T très grasse: on adapte ou on évite.", "cta": "La tendance ne connaît pas ta peau."},
    ...
    },
    {
        ...
        "slides": [
            {"bg": IRIS/"022-skin-flooding-body-v1.webp", "kicker": "Mythe", "title": "Le glow K-beauty n'est pas une couche de gras.", "body": "Mool-gwang parle d'eau et de lumière, pas d'une surface saturée.", "cta": "Sauvegarde si ta routine brille mais tire."},
