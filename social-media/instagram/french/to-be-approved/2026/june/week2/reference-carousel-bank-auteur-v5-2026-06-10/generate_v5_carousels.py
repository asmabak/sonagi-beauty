...
decks = [
    {
        ...
        "shop_cta": "Shoppe l'Anua Heartleaf via le tag boutique IG/TikTok Shop.",
    ...
    },
    {
        ...
        "shop_cta": "Shoppe le baume Beauty of Joseon via le tag boutique IG/TikTok Shop.",
        "quiz_url": "sonagibeauty.com/consultation.html",
        "article_url": "sonagibeauty.com/ref/techniques/fr/double-cleansing/",
        "slides": [
    ...
    },
    {
        ...
        "shop_cta": "Shoppe la Centella Skin1004 via le tag boutique IG/TikTok Shop.",
        "quiz_url": "sonagibeauty.com/consultation.html",
        "article_url": "sonagibeauty.com/ref/basics/fr/reparer-la-barriere-cutanee/",
        "slides": [
            {"bg": IMG/"basics/la-barriere-cutanee-body-1.webp", "kicker": "Signal faible", "title": "Si tout pique, ce n'est pas que ta peau est capricieuse.", "body": "C'est souvent la barrière qui fuit. Et sur un mur fissuré, plus d'actifs ne réparent rien.", "cta": "Sauvegarde avant d'ajouter un nouveau sérum.", "anchor": "right"},
            {"bg": IMG/"basics/_originals/skin-barrier-asma.png", "kicker": "Le besoin", "title": "Briques, ciment, eau retenue.", "body": "Les cellules sont les briques. Les lipides sont le ciment. Quand le ciment manque, l'eau sort et les irritants entrent.", "visual": DIA/"la-barriere-cutanee.webp", "cta": "La peau qui tire demande moins, pas plus.", "anchor": "right"},
    ...
    },
    {
        ...
        "shop_cta": "Shoppe l'Anua Heartleaf via le tag boutique IG/TikTok Shop.",
        "quiz_url": "sonagibeauty.com/consultation.html",
        "article_url": "sonagibeauty.com/ref/basics/fr/le-sebum/",
        "slides": [
            {"bg": IMG/"basics/hormones-phase-6-real.webp", "kicker": "Hot take", "title": "Plus tu assèches ta peau grasse, plus elle négocie.", "body": "Le sébum n'est pas une saleté. C'est une couche protectrice. Le but, c'est réguler, pas exterminer.", "cta": "Sauvegarde si tu matifies toute la journée.", "anchor": "left"},
            {"bg": IMG/"basics/_originals/skin-ph-asma.png", "kicker": "Le besoin", "title": "Le sébum sort d'une usine sous le pore.", "body": "Il remonte le long du follicule, se mélange aux lipides et forme le film hydrolipidique.", "visual": DIA/"le-sebum.webp", "cta": "Briller un peu n'est pas échouer."},
    ...
    },
    {
        ...
        "shop_cta": "Shoppe le SPF Beauty of Joseon via le tag boutique IG/TikTok Shop.",
        "quiz_url": "sonagibeauty.com/consultation.html",
...
def main():
    ...
    bank = f"""<!doctype html><html lang="fr"><meta charset="utf-8"><title>Sonagi V5 Auteur carousel bank</title>
...
<header><h1>Sonagi V5 Auteur carousel bank</h1><p>No-card editorial system: full-bleed image, readable text, unique contextual image per slide, Kbeauty Gems structure.</p></header><main>{''.join(cards)}</main></html>"""
