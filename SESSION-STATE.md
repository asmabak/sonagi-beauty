...
4. **NEVER spend money. User decides every purchase.** Claude can RECOMMEND paid tools openly (with price + free alternatives), but must never sign up, click subscribe/upgrade, enter payment, or auto-trial. Approval for one purchase does not generalize. See `~/.claude/projects/.../memory/feedback_never_pay.md` for full rule.
